...
def _resolve_local_path(name: str) -> str | None:
    if not FLUX_MODEL_DIR:
        return None
    local_path = os.path.join(FLUX_MODEL_DIR, name)
...
def load_t5(device: str | torch.device = "cuda", max_length: int = 512) -> HFEmbedder:
    ...
    model_path = _resolve_local_path("text_encoder_2") or "google/t5-v1_1-xxl"
    tokenizer_path = _resolve_local_path("tokenizer_2")
    return HFEmbedder(
        model_path,
...
def load_clip(device: str | torch.device = "cuda") -> HFEmbedder:
    cache_dir = os.environ.get("HF_HOME")
    model_path = _resolve_local_path("text_encoder") or "openai/clip-vit-large-patch14"
    tokenizer_path = _resolve_local_path("tokenizer")
    return HFEmbedder(
        model_path,
        max_length=77,
        tokenizer_path=tokenizer_path,
